...
class Libido:
    ...
    def __init__(self):
        ...
        # TODO currently too low to accomodate small size of the dummy dataset being used educationally
        batch_size = 8
        ...
        # Train and evaluate
        model_ft, hist = self.train_model(model_ft, dataloaders_dict, criterion, optimizer_ft, num_epochs=num_epochs,
